...
**
** Created: Sat Feb 6 01:46:52 2010
...
static const char qt_meta_stringdata_Debugger[] = {
    "Debugger\0\0message\0messagePrinted(QString)\0"
};

const QMetaObject Debugger::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Debugger,
...
int Debugger::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: messagePrinted((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void Debugger::messagePrinted(QString _t1)
{
