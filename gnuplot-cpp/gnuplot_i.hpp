...
class Gnuplot
{
    ...
    /// \return ---
    //----------------------------------------------------------------------------------
    inline Gnuplot& replot(){if (nplots > 0) cmd("replot");return *this;};
    ...
    Gnuplot& save(const std::string &filename = "gnuplot_output");
...
static void stringtok (Container &container,
                std::string const &in,
